...
<nav class="navbar-custom">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-1 flex-wrap">
            <a href="{{ url('/') }}" class="nav-pill-link {{ $active === 'home' ? 'is-active' : '' }}">
            ...
            <a href="{{ url('/fleet') }}" class="nav-pill-link {{ $active === 'module4' ? 'is-active' : '' }}">
            ...
            <a href="{{ url('/auth/login') }}" class="nav-pill-link nav-no-auth {{ $active === 'login' ? 'is-active' : '' }}">
                <i class="bi bi-box-arrow-in-right me-1"></i>Login
            </a>

            <!-- Tombol Profil (Hanya muncul jika sudah login) -->
            <a href="{{ url('/auth/profile') }}" class="nav-pill-link nav-needs-auth {{ $active === 'profile' ? 'is-active' : '' }}">
